...
<head>
    ...
    <link href="{{ asset('front_assets/img/icons8-portfolio-48.png') }}" rel="icon">
    ...
    {{-- <link href="{{ asset('admin_assets/fontawesome-free-5.15.3-web/css/all.css') }}" rel="stylesheet" media="all"> --}}
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="@yield('dashboard_select') has-sub">
                            <a class="js-arrow" href="{{ route('admin.dashboard') }}">
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
                        </li>
                        <li class="@yield('home_select') has-sub">
                            <a class="js-arrow" href="{{ route('admin.home') }}">
                                <i class="fas fa-home"></i>Home</a>
                        </li>
                        <li class="@yield('resume_select') has-sub">
                            <a class="js-arrow" href="{{ route('admin.resume') }}">
                                <i class="fas fa-file"></i>Resume</a>
                        </li>
                        <li class="@yield('contact_select') has-sub">
                            <a class="js-arrow" href=" ">
                                <i class="fas fa-envelope"></i>Messages</a>
                        </li>
                        <li class="@yield('mywork_select') has-sub">
                            <a class="js-arrow" href="{{ route('admin.mywork') }} ">
                                <i class="fas fa-tasks"></i>My Work</a>
                        </li>
                        <li class="@yield('about_select') has-sub">
                            <a class="js-arrow" href="{{ route('admin.about') }}">
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('service_select') has-sub">
                            <a class="js-arrow" href="{{ route('admin.manage_service') }}">
                                <i class="fas fa-info"></i>Services</a>
                        </li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2021 My Cart. All rights reserved. Template by <a
                                            href="https://colorlib.com">My Cart</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
